...
function Comments({post,user}){
    ...
    return <div>
        ...
        {comments.map(c =>
            <Comment key={c.id} comment={c} canEdit={c.author.id === user} onDelete={deleteComment} onUpdate={updateComment}/>
        )}
...
const CommentForm = React.memo(({post,onComment,comment = null, onCancel = null}) => {
    ...
    return <div className="well">
        <form onSubmit={onSubmit}>
            ...
            <Field name="content" help="Les commentaires non conformes à notre code de conduite seront modérés." ref={ref} required minLength={5} onChange={clearError.bind(this,'content')} error={errors['content']}>Votre commentaire</Field>
